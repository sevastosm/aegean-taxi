...
const LocationInput = ({ direction, param, onClear, setFocused, placeholder,
    originParam, destinationParam, onChange
}) => {
    ...
    return (
        <div className="relative flex items-center">
            ...
            <input
                ...
                // }}
                className={`pl-8 pr-8 py-3 border-2 rounded font-semibold focus:outline-none ${originParam ? "bg-gray-300" : "bg-white border-[#244284]"
                    } w-full`}
