...
function OrderDetails({
  ...
  const showDriverDetails =
    screen === "reservation-confirmed" || screen === "reservation-on-the-way";

  const showOrderData =
    screen === "reservation-confirmed" || screen === "reservation-received";
  ...
  return (
    <div className="flex flex-col min-h-[87vh] -mt-3">
      ...
      <div className="max-w-[500px] flex-1 flex flex-col w-full mx-auto">
        ...
        {showDriverDetails && orderDetails && (
          <DriverOnTheWay orderDetails={orderDetails} screen={screen} />
        )}
        {screen === "reservation-received" && (
    ...
    <div className="mt-3">
      ...
      <div className="flex flex-col items-center justify-center flex-grow mx-4">
        ...
        <div className="flex items-center justify-center mt-3">
          <p className="text-lg ">
            {" "}
            {orderDetails.car.color} {orderDetails.car.model}
          </p>
        </div>
        <div className="flex items-center justify-center mt-3">
        ...
        <div className="flex  items-center justify-between w-full mt-3 max-w-[300px] mx-auto">
          <div className="flex flex-col items-center justify-center">
            ...
            >
              <path
                d="M9.45222 20.3406C13.2122 27.73 19.27 33.7878 26.6594 37.5478L32.4039 31.8033C33.135 31.0722 34.1533 30.8633 35.0672 31.1506C37.9917 32.1167 41.125 32.6389 44.3889 32.6389C45.0814 32.6389 45.7455 32.914 46.2352 33.4037C46.7249 33.8933 47 34.5575 47 35.25V44.3889C47 45.0814 46.7249 45.7455 46.2352 46.2352C45.7455 46.7249 45.0814 47 44.3889 47C32.6162 47 21.3257 42.3233 13.0012 33.9988C4.67667 25.6743 0 14.3838 0 2.61111C0 1.9186 0.275098 1.25445 0.764777 0.764777C1.25445 0.275098 1.9186 0 2.61111 0H11.75C12.4425 0 13.1067 0.275098 13.5963 0.764777C14.086 1.25445 14.3611 1.9186 14.3611 2.61111C14.3611 5.875 14.8833 9.00833 15.8494 11.9328C16.1367 12.8467 15.9278 13.865 15.1967 14.5961L9.45222 20.3406Z"
                fill="#05C342"
              />
            </svg>
          </div>
          <p className="text-xl font-semibold text-blue-800 tracking-wide">
