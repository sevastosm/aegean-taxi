...
import AUS from "public/assets/flags/au.svg";
    ...
    <Container maxWidth={"lg"}>
      <Grid container spacing={0}>
        <Grid item xs={12} md={6}>
          ...
          >
            What travelers who booked a ride with Aegean Taxi in Santorini say
            about us
          </Typography>
        </Grid>
        <Grid item xs={12} md={6}>
                ...
                >
                  <Box sx={{ p: 2 }}>
                    ...
                    >
                      ...
                      book our rides with just a phone call where confirmed all
                      the details. The drivers were amazing and with local
                      knowledge.
                    </Typography>
                ...
                >
                  <Box sx={{ p: 2 }}>
                    ...
                    >
                      ...
                      comunication was via Whatsapp and the best thing was being
                      able to pin our location as there was some points where we
                      were not entirely sure! All drivers were amazing, very
                      polite, and friendly. Definitely recommend!
                    </Typography>
                ...
                >
                  <Box sx={{ p: 2 }}>
                    ...
                    >
                      ...
                      are very professional. The app was very easy to use and
                      very precise with ETA. Would recommend and use it again!
                    </Typography>
